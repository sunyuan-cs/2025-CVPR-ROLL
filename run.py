...
parser.add_argument('-li', '--log-interval', default='10', type=int, help='interval for logging info')
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    ncl_loss_value = 0
    ver_loss_value = 0
    for batch_idx, (x0, x1, labels, real_labels, _) in enumerate(train_loader):
